...
# define FL_CEIL_M 17
# define FL_CE_MISS "FILE invalid: unable to process fl/ceil RGBs values...\n" 
# define RGB_W 18
...
# define MISS_MAP "FILE invalid: No map or map not processable\n" 
# define ORDER_ID 22 
...
# define MLXIN 100
# define MLXIN_M "MLX: mlx initialization failed\n"
# define MLXWI 101
# define MLXWI_M "MLX:mlx window creation failed\n"
# define MLXIMG 102
# define MLXIMG_M "MLX:mlx image creation failed\n"
# define MLXSIZ 103
# define MLXSIZ_M "MLX: given textures are not of size 64x64\n"
